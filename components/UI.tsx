    ...
    <>
      ...
      <div className="absolute inset-0 pointer-events-none p-6 md:p-10 z-10 flex flex-col justify-between">
        ...
        <div className="flex justify-between items-start w-full">
            ...
            {/* Header (Top Left) */}
            <div className={`flex flex-col items-start gap-4 transition-opacity duration-1000 ${isRideMode ? 'opacity-0' : 'opacity-100'}`}>
                ...
                <div className="pointer-events-auto mt-1">
                    ...
                    <div className={`
                        ...
                        ${isCameraEnabled ? 'bg-[#ffd700]/10 shadow-[0_0_10px_rgba(255,215,0,0.2)]' : 'bg-transparent'}
                    `}>
                        <div className={`
                            w-2.5 h-2.5 rounded-full bg-[#ffd700] shadow-sm transition-transform duration-300
                            ${isCameraEnabled ? 'translate-x-3.5 shadow-[0_0_10px_#ffd700]' : 'translate-x-0'}
                        `}/>
                    </div>
        ...
        <div className="relative w-full flex items-end justify-center">
             <div 
                className={`transition-all duration-1000 transform ${isTreeReady && !isRideMode ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}
            >
                <form 
